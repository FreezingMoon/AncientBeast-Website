	...
	<div id="mc_embed_signup">
		<form action="//FreezingMoon.us7.list-manage.com/subscribe/post?u=32f1406080b23a82ecf9e8d6b&amp;id=94b74a4105" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
			<div id="mc_embed_signup_scroll">
				<div style="display: inline-block; padding-top: 8px; padding-right: 50px;">
					<label style="font-size: 1.1em;" for="mce-EMAIL">Be part of our mailing list and receive news bulletins!</label><br><br>
					<input type="email" value="" name="EMAIL" class="required email" id="mce-EMAIL" style="width: 100%;" placeholder=" ▷ Simply enter here your email address, you can unsubscribe at any time ◁">
				</div>
