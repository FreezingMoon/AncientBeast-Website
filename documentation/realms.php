...
.top-part { border-radius: 15px 15px 0 0; }
.bottom-part { border-radius: 0 0 15px 15px; }
.realm-image {
	border: 4px;
	border-style: ridge;
	border-top: 0;
...
<div class="center" id="avarice">
<a href="#avarice"><div class="center top-part" style="border-color: gold;">
...
<a href="#envy"><div class="center top-part" style="border-color: orange;">
...
<a href="#gluttony"><div class="center top-part" style="border-color: green;">
...
<br>
<div class="center" id="lust">
<a href="#lust"><div class="center top-part" style="border-color: red;">
...
<a href="#pride"><div class="center top-part" style="border-color: violet;">
<span class="bigger" style="text-shadow: black 0.1em 0.1em 0.2em, violet 0 0 10px;">Pride</span></div>
<img src='../images/realms/pride.jpg' width=942px; style="border-color: violet;" class="realm-image">
<div class="center bottom-part" style="border-color: violet;">
...
<br>
<div class="center" id="sloth">
<a href="#sloth"><div class="center top-part" style="border-color: blue;">
<span class="bigger" style="text-shadow: black 0.1em 0.1em 0.2em, blue 0 0 10px;">Sloth</span></div>
<img src='../images/realms/sloth.jpg' width=942px; style="border-color: blue;" class="realm-image">
<div class="center bottom-part" style="border-color: blue;">
...
<br>
<div class="center" id="wrath">
<a href="#wrath"><div class="center top-part" style="border-color: indigo;">
